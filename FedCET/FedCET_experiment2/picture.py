...
##########################################################
 ...
 #   plt.semilogy(x,y,label='FedCET', color='y',linewidth=2.4,linestyle='solid')
    ...
    plt.savefig(fname="stochastic_different_algorithm_TAU3.jpg",format="jpg", bbox_inches='tight')
    plt.savefig(fname="stochastic_different_algorithm_TAU3.pdf",format="pdf", bbox_inches='tight')
    plt.show() 
